...
class Mage_Paymentz_Model_Config
{
	...
	{   if(Mage::getStoreConfig('payment/Paymentz/test')){
		...
		$url="https://".Mage::getStoreConfig('payment/Paymentz/testurl')."/transaction/PayProcessController";
		return $url;
	} else
		...
		// $urllive = Mage::getStoreConfig('payment/Paymentz/liveurl');
		 $urllive = "https://".Mage::getStoreConfig('payment/Paymentz/liveurl')."/transaction/PayProcessController";
